  ...
  return (
      ...
      <div style={{display: 'flex', justifyContent: 'center'}}>
        ...
        <div style={{maxWidth: '50%', padding: '40px'}}>
          <>
            <h1 style={{ color: '#1a73e8' }}>Sobre o TextGrader</h1>
            <p>
              O <strong>TextGrader</strong> é uma iniciativa acadêmica desenvolvida no&nbsp;
              <a
            ...
            <p>
              ...
              <a
                href="https://github.com/AILAB-CEFET-RJ/textgrader_tool"
                target="_blank"
                rel="noopener noreferrer"
                style={{ color: '#1a73e8' }}
              >
